...
function ensureAdmin() {
  ...
  db.prepare(`INSERT INTO users (role, first_name, email, password_hash, ref_code, is_super) VALUES ('admin','Admin',?,?,?,1)`)
    .run(email.toLowerCase(), hash, refCode);
  console.log(`Created default super-admin account: ${email} / ${password}  -- change this password after first login`);
}
ensureAdmin();
